...
public class CacahKramaMipilListAdapter extends RecyclerView.Adapter<CacahKramaMipilListAdapter.ViewHolder> {
    ...
    public CacahKramaMipilListAdapter(Context context, ArrayList<CacahKramaMipil> cacahKramaMipilArrayList) {
        mContext = context;
    ...
    @NonNull
    @Override
    public CacahKramaMipilListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.cacah_krama_mipil_card_layout, parent, false);
        return new CacahKramaMipilListAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CacahKramaMipilListAdapter.ViewHolder holder, int position) {
