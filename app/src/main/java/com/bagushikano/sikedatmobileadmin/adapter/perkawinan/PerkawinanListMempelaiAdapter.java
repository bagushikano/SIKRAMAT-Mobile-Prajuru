...
public class PerkawinanListMempelaiAdapter extends RecyclerView.Adapter<PerkawinanListMempelaiAdapter.ViewHolder> {
     ...
     * Pradana = 1
     */
    private final Integer flagPasangan;

    public PerkawinanListMempelaiAdapter(Context context, ArrayList<CacahKramaMipil> cacahKramaMipilArrayList, Integer flagPasangan) {
        mContext = context;
        this.cacahKramaMipilArrayList = cacahKramaMipilArrayList;
        this.flagPasangan = flagPasangan;
    }

    @NonNull
    @Override
    public PerkawinanListMempelaiAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.perkawinan_mempelai_card_layout, parent, false);
        return new PerkawinanListMempelaiAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull PerkawinanListMempelaiAdapter.ViewHolder holder, int position) {
