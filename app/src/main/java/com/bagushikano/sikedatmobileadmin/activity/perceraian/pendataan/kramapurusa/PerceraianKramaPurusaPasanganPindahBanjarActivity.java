...
public class PerceraianKramaPurusaPasanganPindahBanjarActivity extends AppCompatActivity {
    ...
    private Boolean isKramaMipilSelected = false, isStatusBaruSelected = false;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_perceraian_krama_purusa_pasangan_pindah_banjar);
...
//        maperasKabupatenAutoComplete.setThreshold(100);
        ...
        maperasBanjarAdatAutoComplete.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Snackbar.make(getWindow().getDecorView().findViewById(android.R.id.content),
                        "Berhasil memilih Banjar Adat. Silahkan pilih Krama/Keluarga.", Snackbar.LENGTH_SHORT).show();
            }
        });
        ...
        peceraianNextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isStatusBaruSelected && isKramaMipilSelected) {
