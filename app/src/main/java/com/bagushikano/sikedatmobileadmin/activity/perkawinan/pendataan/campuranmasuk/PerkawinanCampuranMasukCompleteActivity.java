...
public class PerkawinanCampuranMasukCompleteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_perkawinan_campuran_masuk_complete);
        ...
        perkawinanJenis.setText("Campuran Masuk");

        perkawinanDetailButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent perkawinanDetail = new Intent(getApplicationContext(), PerkawinanCampuranMasukDetailActivity.class);
