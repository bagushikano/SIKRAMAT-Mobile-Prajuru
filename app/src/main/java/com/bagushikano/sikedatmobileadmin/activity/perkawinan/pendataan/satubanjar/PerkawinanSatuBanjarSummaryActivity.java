...
public class PerkawinanSatuBanjarSummaryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_perkawinan_satu_banjar_summary);
        ...
        if (getIntent().hasExtra(AKTA_FILE_KEY)) {
            ...
            aktaFileButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    FileOpenUtil fileOpenUtil = new FileOpenUtil(PerkawinanSatuBanjarSummaryActivity.this);
    ...
    public void submitData() {
        RequestBody purusaData, pradanaData, noBuktiSerahTerimaData, noAktaData, tanggalPerkawinanData,
        ...
        perkawinanStoreResponseCall = retro.perkawinanStoreSatuBanjarAdat(
                "Bearer " + loginPreferences.getString("token", "empty"),
                purusaData, pradanaData, noBuktiSerahTerimaData, noAktaData, tanggalPerkawinanData,
        ...
        perkawinanStoreResponseCall.enqueue(new Callback<PerkawinanDetailResponse>() {
            ...
            public void onResponse(Call<PerkawinanDetailResponse> call, Response<PerkawinanDetailResponse> response) {
                ...
                if (response.code() == 200 && response.body().getStatusCode() == 200 && response.body().getMessage().equals("data perkawinan sukses")) {
                    Intent perkawinanPendataanCompleteIntent = new Intent(getApplicationContext(), PerkawinanSatuBanjarCompleteActivity.class);
                    Gson gson = new Gson();
