...
public class MaperasCampuranKeluarSummaryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maperas_campuran_keluar_summary);
        ...
        desaDinas = gson.fromJson(getIntent().getStringExtra("BANJAR_KEY"), DesaDinas.class);
        ...
        alamatAsal.setText(maperas.getAlamatAsal().toString());
        desDinasAsal.setText(desaDinas.getName());
        namaAyah.setText(maperas.getNamaAyahBaru().toString());
        namaIbu.setText(maperas.getNamaIbuBaru().toString());
        ...
        if (getIntent().hasExtra(AKTA_FILE_KEY)) {
            ...
            aktaFileButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    FileOpenUtil fileOpenUtil = new FileOpenUtil(MaperasCampuranKeluarSummaryActivity.this);
    ...
    public void submitData() {
        ...
        maperasDetailResponseCall = retro.storeMaperasCampuranKeluar(
        ...
        maperasDetailResponseCall.enqueue(new Callback<MaperasDetailResponse>() {
            ...
            public void onResponse(Call<MaperasDetailResponse> call, Response<MaperasDetailResponse> response) {
                ...
                if (response.code() == 200 && response.body().getStatusCode() == 200 && response.body().getMessage().equals("data maperas sukses")) {
                    Intent perkawinanPendataanCompleteIntent = new Intent(getApplicationContext(), MaperasCampuranKeluarCompleteActivity.class);
                    Gson gson = new Gson();
