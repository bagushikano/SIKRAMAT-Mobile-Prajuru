...
public class PerkawinanCampuranMasukStatusKekeluargaanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_perkawinan_campuran_masuk_status_kekeluargaan);
        ...
        perkawinan = gson.fromJson(getIntent().getStringExtra(CAMPURAN_KEY), Perkawinan.class);
        ...
        perkawinanNextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent perkawinanNext = new Intent(getApplicationContext(), PerkawinanCampuranMasukDataPerkawinanActivity.class);
