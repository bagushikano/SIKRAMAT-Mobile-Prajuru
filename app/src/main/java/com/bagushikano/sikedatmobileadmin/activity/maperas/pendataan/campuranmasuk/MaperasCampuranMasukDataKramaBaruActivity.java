...
import com.bagushikano.sikedatmobileadmin.activity.maperas.pendataan.satubanjar.MaperasSatuBanjarDataMaperasActivity;
import com.bagushikano.sikedatmobileadmin.activity.maperas.pendataan.satubanjar.MaperasSatuBanjarKramaMipilBaruSelectActivity;
...
public class MaperasCampuranMasukDataKramaBaruActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maperas_campuran_masuk_data_krama_baru);
        ...
        maperas = gson.fromJson(getIntent().getStringExtra(CAMPURAN_KEY), Maperas.class);
        ...
        maperasSelectKramaButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent maperasSelectKramaIntent = new Intent(getApplicationContext() , MaperasCampuranMasukKramaMipilBaruSelectActivity.class);
                ...
                new ActivityResultCallback<ActivityResult>() {
                    ...
                    public void onActivityResult(ActivityResult result) {
                        if (result.getResultCode() == 1) {
                            ...
                            getOrtuBaru(kramaMipilBaru.getId(), loginPreferences.getString("token", "empty"));
        ...
        maperasNextButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (isKramaSelected && isAyahSelected && isIbuSelected) {
                    maperas.setAyahBaruId(ayahAnggotaKeluarga.getId());
                    ...
                    Intent maperasIntent = new Intent(getApplicationContext(), MaperasCampuranMasukDataMaperasActivity.class);
                    ...
                    Snackbar.make(getWindow().getDecorView().findViewById(android.R.id.content),
                            "Terdapat data yang belum valid. Periksa data kembali.", Snackbar.LENGTH_SHORT).show();
                }
            }
        });
    }

    public void getOrtuBaru(Integer idKrama, String token) {
