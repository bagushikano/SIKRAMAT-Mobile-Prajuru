...
public class PerkawinanCampuranKeluarCompleteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_perkawinan_campuran_keluar_complete);
        ...
        perkawinanPradanaName.setText(
               perkawinan.getNamaPasangan().toString()
        );
        ...
        perkawinanDetailButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent perkawinanDetail = new Intent(getApplicationContext(), PerkawinanCampuranKeluarDetailActivity.class);
