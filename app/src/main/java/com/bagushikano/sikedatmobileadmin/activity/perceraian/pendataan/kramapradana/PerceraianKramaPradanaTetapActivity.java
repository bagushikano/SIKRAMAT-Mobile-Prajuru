...
import com.bagushikano.sikedatmobileadmin.activity.perceraian.pendataan.kramapurusa.PerceraianKramaPurusaPasanganKeluarBaliActivity;
import com.bagushikano.sikedatmobileadmin.activity.perceraian.pendataan.kramapurusa.PerceraianKramaPurusaPasanganPindahBanjarActivity;
...
public class PerceraianKramaPradanaTetapActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_perceraian_krama_pradana_tetap);
...
//                    }
                } else if (perceraian.getStatusPradana().equals("keluar_banjar")) {
                    // arahin ke milih keluarga dan banjar
                    perceraianNext = new Intent(getApplicationContext(), PerceraianKramaPradanaPindahBanjarActivity.class);
                } else if (perceraian.getStatusPradana().equals("keluar_bali")) {
                    // arahin ke keluar bali
                    perceraianNext = new Intent(getApplicationContext(), PerceraianKramaPradanaKeluarBaliActivity.class);
                }
                if (anggotaKramaMipilArrayList.size() != 0) {
