...
public class MaperasCampuranKeluarCompleteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maperas_campuran_keluar_complete);
        ...
        maperasNamaAnak.setText(maperas.getCacahKramaMipilLama().getPenduduk().getNama());
        ...
        maperasDetail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent perkawinanDetail = new Intent(getApplicationContext(), MaperasCampuranKeluarDetailActivity.class);
