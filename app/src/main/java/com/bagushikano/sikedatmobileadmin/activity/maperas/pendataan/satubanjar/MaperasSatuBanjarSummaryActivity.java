...
public class MaperasSatuBanjarSummaryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maperas_satu_banjar_summary);
        ...
        if (getIntent().hasExtra(AKTA_FILE_KEY)) {
            ...
            aktaFileButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    FileOpenUtil fileOpenUtil = new FileOpenUtil(MaperasSatuBanjarSummaryActivity.this);
    ...
    public void submitData() {
        ...
        maperasDetailResponseCall = retro.storeMaperasSatuBanjar(
        ...
        maperasDetailResponseCall.enqueue(new Callback<MaperasDetailResponse>() {
            ...
            public void onResponse(Call<MaperasDetailResponse> call, Response<MaperasDetailResponse> response) {
                ...
                if (response.code() == 200 && response.body().getStatusCode() == 200 && response.body().getMessage().equals("data maperas sukses")) {
                    Intent perkawinanPendataanCompleteIntent = new Intent(getApplicationContext(), MaperasSatuBanjarCompleteActivity.class);
                    Gson gson = new Gson();
