...
import com.bagushikano.sikedatmobileadmin.activity.perkawinan.pendataan.satubanjar.PerkawinanSatuBanjarDataPerkawinanActivity;
...
public class PerkawinanBedaBanjarStatusKekeluargaanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_perkawinan_beda_banjar_status_kekeluargaan);
        ...
        perkawinanNextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent perkawinanNext = new Intent(getApplicationContext(), PerkawinanBedaBanjarDataPerkawinanActivity.class);
                ...
                perkawinanNext.putExtra("BANJAR_KEY", getIntent().getIntExtra("BANJAR_KEY", -1));
                if (getIntent().hasExtra("EDIT_PERKAWINAN")) {
                    perkawinanNext.putExtra("EDIT_PERKAWINAN", "duar");
                }
    ...
    public void setEdit() {
        if (perkawinan.getStatusKekeluargaan().equals("tetap")) {
            perkawinanStatusKekeluargaanRadioGroup.check(R.id.perkawinan_kekeluargaan_stay_radio);
            statusKekeluargaan = "tetap";
            perkawinanKekeluargaanKepalaKeluargaCard.setVisibility(GONE);
        } else if (perkawinan.getStatusKekeluargaan().equals("baru")) {
            statusKekeluargaan = "baru";
            perkawinanStatusKekeluargaanRadioGroup.check(R.id.perkawinan_kekeluargaan_new_radio);
            perkawinanKekeluargaanKepalaKeluargaCard.setVisibility(View.VISIBLE);
        }
        perkawinan.setStatusKekeluargaan(statusKekeluargaan);
        isStatusKeluargaSelected = true;

        if (perkawinan.getCalonKramaId().equals(perkawinan.getPurusaId())) {
            perkawinanKekeluargaanKepalaKeluargaAutoComplete.setText(perkawinan.getPurusa().getPenduduk().getNama());
            perkawinan.setCalonKramaId(perkawinan.getPurusaId());
        } else {
            perkawinanKekeluargaanKepalaKeluargaAutoComplete.setText(perkawinan.getPradana().getPenduduk().getNama());
            perkawinan.setCalonKramaId(perkawinan.getPradanaId());
        }
