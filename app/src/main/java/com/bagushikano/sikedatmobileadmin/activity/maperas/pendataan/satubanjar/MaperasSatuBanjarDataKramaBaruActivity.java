...
public class MaperasSatuBanjarDataKramaBaruActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maperas_satu_banjar_data_krama_baru);
        ...
        maperasSelectKramaButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent maperasSelectKramaIntent = new Intent(getApplicationContext() , MaperasSatuBanjarKramaMipilBaruSelectActivity.class);
        ...
        maperasNextButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (isKramaSelected && isIbuSelected && isAyahSelected) {
                    maperas.setAyahBaruId(ayahAnggotaKeluarga.getId());
                    ...
                    Intent maperasIntent = new Intent(getApplicationContext(), MaperasSatuBanjarDataMaperasActivity.class);
