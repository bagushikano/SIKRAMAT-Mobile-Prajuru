...
public class MaperasCampuranMasukCompleteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maperas_campuran_masuk_complete);
        ...
        maperasDetail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent perkawinanDetail = new Intent(getApplicationContext(), MaperasCampuranMasukDetailActivity.class);
