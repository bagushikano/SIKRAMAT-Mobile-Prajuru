...
public class PerkawinanSatuBanjarCompleteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_perkawinan_satu_banjar_complete);
        ...
        perkawinanJenis.setText("Satu Banjar Adat");

        perkawinanDetailButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent perkawinanDetail = new Intent(getApplicationContext(), PerkawinanSatuBanjarDetailActivity.class);
