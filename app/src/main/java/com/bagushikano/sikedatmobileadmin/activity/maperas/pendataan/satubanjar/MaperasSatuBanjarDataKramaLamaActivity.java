...
public class MaperasSatuBanjarDataKramaLamaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maperas_satu_banjar_data_krama_lama);
        ...
        maperasNextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isAnakSelected && isKramaSelected) {
                    Intent maperasNextIntent = new Intent(getApplicationContext(), MaperasSatuBanjarDataKramaBaruActivity.class);
